    ...
    <Container>
        ...
        <Content>
            {`국내에서는 실험실용으로 Borosilicate Glass가 생산이 되지않아 전량 수입에 의존하고 있습니다. 수입되는 규격은 Corning사의 Lab사이즈
             ...
             먼저 Joint는 국제 표준에 의해 전세계적으로 만들어진 제품은 Js,Ts라 표시하며 Js는 Spherical를 의미하며 Ts는 Standerd Taper를 의미합니다. Taper ground joint 규격은 국내에서 통상 Full, Medium 규격이 통용됩니다.
        ...
        <Content>
            {`통상적으로 유리기구 세척은 세제를 사용하여 세척하거나 초음파 세척기를 사용하기도 합니다.
              ...
              Na2Cr207, 2H2O, 92gr을 물 460ml에 녹입니다. 이 용액에 진한황산 800ml를 천천히 넣으면서 잘 교반합니다. 이 용액에서 잘 세척되지 않을 경우는 1L 진한황산에 Na2Cr207, 2H2O 포화 수용액을 35ml 쯤 넣어 사용합니다. 대부분의 오염물질은 이 용액에 하루정도 담그면 깨끗하게 제거됩니다.
